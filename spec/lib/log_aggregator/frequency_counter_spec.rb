...
describe LogAggregator::FrequencyCounter do
  ...
  it 'counts rate of previously seen events' do
    event_attrs = {'store' => 'itunes_connect', 'app_id' => 1002393085, 'country_iso' => 'PH', 'date' => '2015-09-15'}

    counter.register_event(event_attrs, DateTime.parse('2015-09-15T16:13:03+02:00'))

    collection = '2015-09-15'
